...
export const StudioHero: React.FC<IStudioHeroProps> = ({ studio }) => {
    ...
    // Fetch 5 random scenes for this studio
    const filter = useMemo(() => {
        ...
        f.criteria.push(studioCriterion);

        return f;
    }, [configuration, studio.id, studio.name]);
