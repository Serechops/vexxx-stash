...
export const ImagesHero: React.FC = () => {
    ...
    return (
        <div className="hidden md:flex relative w-full h-[60vh] overflow-hidden bg-background select-none pointer-events-none items-center justify-center perspective-1000">
