...
func (l *SceneLastPlayedLoader) Load(key int) (*Timestamp, error) {
...
func (l *SceneLastPlayedLoader) LoadThunk(key int) func() (*Timestamp, error) {
	l.mu.Lock()
...
func (l *SceneLastPlayedLoader) LoadAll(keys []int) ([]*Timestamp, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *SceneLastPlayedLoader) LoadAllThunk(keys []int) func() ([]*Timestamp, []error) {
	results := make([]func() (*Timestamp, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *SceneLastPlayedLoader) Prime(key int, value *Timestamp) bool {
	l.mu.Lock()
	var found bool
...
func (l *SceneLastPlayedLoader) unsafeSet(key int, value *Timestamp) {
	if l.cache == nil {
